...
import recurringexpensetracker.shared.generated.resources.edit_expense_end_date
import recurringexpensetracker.shared.generated.resources.edit_expense_end_date_placeholder
...
fun EndDateOption(
    ...
    val formattedDate =
        date?.toLocaleString()
            ?: stringResource(Res.string.edit_expense_end_date_placeholder)

    Column(modifier = modifier.padding(vertical = 8.dp)) {
        Text(
            text = stringResource(Res.string.edit_expense_end_date),
