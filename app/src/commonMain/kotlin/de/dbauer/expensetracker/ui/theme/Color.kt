...
import de.dbauer.expensetracker.useDarkTheme
...
val expense_predefined_red
    @Composable
    get() = if (useDarkTheme()) Color(0x80ff6666) else Color(0x80990000)

val expense_predefined_orange
    @Composable
    get() = if (useDarkTheme()) Color(0x80ffb366) else Color(0x80994d00)

val expense_predefined_yellow
    @Composable
    get() = if (useDarkTheme()) Color(0x80ffff66) else Color(0x80999900)

val expense_predefined_green
    @Composable
    get() = if (useDarkTheme()) Color(0x8066ff66) else Color(0x80009900)

val expense_predefined_mint
    @Composable
    get() = if (useDarkTheme()) Color(0x8066ffb3) else Color(0x8000994d)

val expense_predefined_turquoise
    @Composable
    get() = if (useDarkTheme()) Color(0x8066ffff) else Color(0x80009999)

val expense_predefined_cyan
    @Composable
    get() = if (useDarkTheme()) Color(0x8066b2ff) else Color(0x80004c99)

val expense_predefined_blue
    @Composable
    get() = if (useDarkTheme()) Color(0x807f66ff) else Color(0x80000099)

val expense_predefined_purple
    @Composable
    get() = if (useDarkTheme()) Color(0x80cc66ff) else Color(0x804c0099)

val expense_predefined_pink
    @Composable
    get() = if (useDarkTheme()) Color(0x80ff66ff) else Color(0x80990099)

val expense_predefined_maroon
    @Composable
    get() = if (useDarkTheme()) Color(0x80ff66b3) else Color(0x8099004d)
